...

{
    ...
    \vspace{-3mm}
    \textbf{Even if you are an experienced builder, please make sure to follow the steps in the
        correct order when building this kit. Some sections are very dense and might be hard
        (or even impossible) to assemble in the wrong order.
    }
    \vspace{5mm}
}
